...
public class TravelPlanDTO {
    ...
    private String linkedJourneyTitle;
    ...
    public String getLinkedJourneyTitle() {
        return linkedJourneyTitle;
    }

    public void setLinkedJourneyTitle(String linkedJourneyTitle) {
        this.linkedJourneyTitle = linkedJourneyTitle;
    }
